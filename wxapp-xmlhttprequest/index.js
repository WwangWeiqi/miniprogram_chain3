...
__DEFINE__(1581684496670, function(require, module, exports) {
...
var XMLHttpRequest = /** @class */ (function (_super) {
    ...
    XMLHttpRequest.prototype.open = function (method, url, async, user, password) {
        ...
        this.dispatchEvent(EVENT_READY_STATE_CHANGE);
    };
    /**
     * send data
     * @param data
  ...
  // const regeneratorRuntime = require('../regenerator/runtime.js');
      ...
      //  console.log(this);
        ...
        if (this.timeout > 0) {
            timer = setTimeout(function () {
                ...
                _this.dispatchEvent(EVENT_TIMEOUT);
            }, this.timeout);
        }
        this.__requestTask = wx.request({
            url: this.__url,
            ...
            success: function (res) {
              // console.log("suc", res)
                ...
                if (_this.__responseStatus >= 400) {
                    _this.dispatchEvent(EVENT_ERROR);
                }
            },
            fail: function (res) {
            ...
            complete: function () {
              // console.log("complete")
                ...
                _this.dispatchEvent(EVENT_READY_STATE_CHANGE);
    ...
    XMLHttpRequest.prototype.abort = function () {
        ...
        this.__aborted = true;
        this.dispatchEvent(EVENT_ABORT);
    };
    /**
     * set request header
     * @param header
...
return __REQUIRE__(1581684496670);
})()
